...
Replaces the per-block widget tree (`AcornMarkdown` -> 50+ widgets)
...
class AcornChunkHybrid(Container):
    ...
    AcornChunkHybrid > .chunk-text-run { height: auto; }
    AcornChunkHybrid > .chunk-fence-run { height: auto; }
    """
